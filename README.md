...
Mini Akinator is a simple Python game that tries to guess the character you’re thinking of by asking a series of questions — inspired by the popular Akinator web game.

## Features

- Interactive guessing game using character traits.
